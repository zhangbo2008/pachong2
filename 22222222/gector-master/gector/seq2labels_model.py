...
class Seq2Labels(Model):
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        self.tag_labels_projection_layer = TimeDistributed(
            Linear(text_field_embedder._token_embedders['bert'].get_output_dim(), self.num_labels_classes)) # 把768映射到28  ,可以修改Linear为transformer
    ...
    def forward(self,  # type: ignore
        ...
        batch_size, sequence_length, _ = encoded_text.size()  # 整个算法的输入.(9, 50, 768)
