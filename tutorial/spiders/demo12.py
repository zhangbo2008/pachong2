...
class DmozSpider4(scrapy.Spider): # 继承Spider类
    ...
    html=' http://www.i21st.cn/story/index_1.html'
    html=html.strip()
...
# 下面是直接匹配方式获取所有index页. 也就是一般需求这么跑就可以获取所有index页了.
    ...
    def parse(self, response): # 一级爬取代码
        ...
        div_list = response.xpath('//div[@class="ft-family ft-red"]/a/@href')  # 加入正则


        div_list=['http://www.i21st.cn'+i.extract() for i in div_list]
